...
extension L10n {
    enum Portability {
        ...
        nonisolated static let exportFilename = LocalizedStringResource("export.filename", defaultValue: "My-Weight-weights.csv", table: "Portability")
        ...
        nonisolated static let reportFilename = LocalizedStringResource("report.filename", defaultValue: "My-Weight-progress.pdf", table: "Portability")
        ...
        nonisolated static let shareAccent = LocalizedStringResource("share.accent", defaultValue: "Accent color", table: "Portability")
        nonisolated static let shareAccentBlue = LocalizedStringResource("share.accent.blue", defaultValue: "Blue", table: "Portability")
        nonisolated static let shareAccentTeal = LocalizedStringResource("share.accent.teal", defaultValue: "Teal", table: "Portability")
        nonisolated static let shareAccentPurple = LocalizedStringResource("share.accent.purple", defaultValue: "Purple", table: "Portability")
        nonisolated static let shareAccentOrange = LocalizedStringResource("share.accent.orange", defaultValue: "Orange", table: "Portability")
        nonisolated static let shareFooter = LocalizedStringResource("share.footer", defaultValue: "Show My Weight footer", table: "Portability")
        ...
        nonisolated static let prepareImage = LocalizedStringResource("share.prepare", defaultValue: "Prepare image", table: "Portability")
        ...
        nonisolated static let shareBrand = LocalizedStringResource("share.brand", defaultValue: "My Weight", table: "Portability")
