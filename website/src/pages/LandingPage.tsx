...
const LandingPage = ({ resolvedTheme, onLearnMore }: LandingPageProps) => {
  return (
    <>
        ...
        <div className="container">
          ...
          >
            ...
            <div className="hero-highlights" role="list">
              <span className="hero-highlight-pill" role="listitem">Private &amp; secure</span>
              <span className="hero-highlight-pill" role="listitem">No account required</span>
              <span className="hero-highlight-pill" role="listitem">Optional iCloud backup</span>
            </div>
            <div className="hero-buttons">
              <a 
                ...
                aria-label="Download TrimTally on the App Store"
              >
              ...
              <button 
                ...
                onClick={onLearnMore}
                aria-label="Learn more about TrimTally features"
              >
      ...
      <section id="features" className="features section" aria-label="App features">
        <div className="container">
        ...
        <div className="container">
          ...
          <div className="screenshots-grid">
            {['dashboard', 'analytics', 'add-entry'].map((name) => (
              <figure className="screenshot-frame" key={name}>
                <img
