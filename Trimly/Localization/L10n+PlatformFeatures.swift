...
extension L10n {
    enum PlatformFeatures {
        ...
        static let healthLocalOnly = LocalizedStringResource("platform.health.localOnly", defaultValue: "Edits and deletions in My Weight affect this app only. They do not change or delete records in Apple Health. Deleted imports may return on a later import.", table: "PlatformFeatures")
