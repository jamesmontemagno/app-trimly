...
enum L10n {
	...
	enum Onboarding {
		...
		static let welcomeTitle = LocalizedStringResource("onboarding.welcome.title", defaultValue: "Welcome to My Weight")
		static let welcomeSubtitle = LocalizedStringResource("onboarding.welcome.subtitle", defaultValue: "Your supportive companion for mindful weight tracking")
			static let cloudSyncChecking = LocalizedStringResource("onboarding.cloudSync.checking", defaultValue: "Looking for your previous My Weight data...")
			...
			static let cloudSyncNoData = LocalizedStringResource("onboarding.cloudSync.noData", defaultValue: "No My Weight data found in iCloud yet—start fresh and we'll sync new entries.")
	...
	enum Reminders {
		...
		static let authorizedDescription = LocalizedStringResource("reminders.authorization.description", defaultValue: "My Weight can send you reminders on this device.")
		...
		static let dailyDescription = LocalizedStringResource("reminders.daily.description", defaultValue: "Choose the best time for My Weight to nudge you to log your weight.")
		...
		static let adaptiveDescription = LocalizedStringResource("reminders.adaptive.description", defaultValue: "Let My Weight learn your habits and recommend smarter reminder times.")
		...
		enum Health {
			...
			static let authorizationDescription = LocalizedStringResource("health.authorization.description", defaultValue: "Allow My Weight to securely read your Health app weight data.")
			...
			static let connectPrompt = LocalizedStringResource("health.authorization.prompt", defaultValue: "Connect to Health so My Weight can keep everything in one place.")
		...
		static let historicalImportTitle = LocalizedStringResource("health.import.title", defaultValue: "Historical Import")
			static let historicalImportDescription = LocalizedStringResource("health.import.description", defaultValue: "Choose a range and pull past weights into My Weight. Duplicates are automatically skipped.")
		...
		static let backgroundSyncTitle = LocalizedStringResource("health.sync.title", defaultValue: "Background Sync")
			static let backgroundSyncDescription = LocalizedStringResource("health.sync.description", defaultValue: "Let My Weight watch for new Health weight samples and keep things tidy.")
		...
		static let syncDirectionDescription = LocalizedStringResource("health.syncDirection.description", defaultValue: "My Weight can read your weight from Health, and optionally write new manual entries back.")
		...
		static let writeFailedHint = LocalizedStringResource("health.error.writeFailedHint", defaultValue: "Saved in My Weight, but couldn't write to Health. Check Health permissions if you want syncing.")
	}
	...
	enum Settings {
		...
		static let personalizationDescription = LocalizedStringResource("settings.section.personalization.description", defaultValue: "Fine-tune how My Weight displays your weight, decimals, and appearance.")
		...
		static let themeSubtitle = LocalizedStringResource("settings.personalization.theme.subtitle", defaultValue: "Choose My Weight's appearance.")
		...
		static let dailyValueDescription = LocalizedStringResource("settings.section.dailyValue.description", defaultValue: "Choose how My Weight treats multiple entries recorded in the same day.")
		...
		static let iCloudSyncRestartMessage = LocalizedStringResource("settings.data.iCloudSync.restart.message", defaultValue: "Please restart My Weight for this change to take effect. Your data is securely encrypted and only accessible from your devices.")
		...
		static let aboutTitle = LocalizedStringResource("settings.section.about.title", defaultValue: "About My Weight")
		...
		static let supportDescription = LocalizedStringResource("settings.section.support.description", defaultValue: "Reach out for help or share feedback with the My Weight team.")
		...
		static let restoreSuccessMessage = LocalizedStringResource("settings.restore.success.message", defaultValue: "Your My Weight Pro purchase has been restored successfully.")
		static let restoreNotFoundTitle = LocalizedStringResource("settings.restore.notFound.title", defaultValue: "No Purchase Found")
		static let restoreNotFoundMessage = LocalizedStringResource("settings.restore.notFound.message", defaultValue: "We couldn't find a previous My Weight Pro purchase associated with your account.")
		static let proStatus = LocalizedStringResource("settings.about.proStatus", defaultValue: "Pro")
		static let proDescription = LocalizedStringResource("settings.about.proDescription", defaultValue: "You have My Weight Pro")
		static let manageProButton = LocalizedStringResource("settings.pro.manageButton", defaultValue: "Manage")
		static let manageProButtonHint = LocalizedStringResource("settings.pro.manageButtonHint", defaultValue: "Opens subscription management options")
		...
		static let reviewAppTitle = LocalizedStringResource("settings.about.reviewApp.title", defaultValue: "Review My Weight")
	...
	enum Paywall {
		static let title = LocalizedStringResource("paywall.title", defaultValue: "Unlock My Weight Pro")
		...
		static func upgradeButtonLabel(_ price: String) -> LocalizedStringResource {
			LocalizedStringResource("paywall.accessibility.upgradeButton", defaultValue: "Upgrade to My Weight Pro for \(price)")
		}
		...
		static let restoreButtonHint = LocalizedStringResource("paywall.accessibility.restoreHint", defaultValue: "Restores your previous My Weight Pro purchase")
	...
	enum Analytics {
		...
		static let categoryLogging = LocalizedStringResource("achievements.category.logging", defaultValue: "Logging")
			...
			static let sectionPremiumHint = LocalizedStringResource("achievements.section.premiumHint", defaultValue: "Upgrade to My Weight Pro to unlock premium achievements.")
			static let proUnlockLine = LocalizedStringResource("achievements.pro.unlockLine", defaultValue: "Unlock this achievement with My Weight Pro.")
			...
			static let loggingLedgerDetail = LocalizedStringResource("achievements.logging.ledger.detail", defaultValue: "Log 100 weight entries")
			...
			static let streakYearTitle = LocalizedStringResource("achievements.streak.year.title", defaultValue: "Year-Long Logger")
			static let streakYearDetail = LocalizedStringResource("achievements.streak.year.detail", defaultValue: "Log 365 days in a row")
			...
			static let consistencySteadyTitle = LocalizedStringResource("achievements.consistency.steady.title", defaultValue: "Steady State")
			static let consistencySteadyDetail = LocalizedStringResource("achievements.consistency.steady.detail", defaultValue: "Log the same weight 5 days in a row")
			...
			static let goalHalfwayTitle = LocalizedStringResource("achievements.goal.halfway.title", defaultValue: "Halfway There")
			static let goalHalfwayDetail = LocalizedStringResource("achievements.goal.halfway.detail", defaultValue: "Reach 50% progress on your first goal")
			...
			static func progressGoalHalfway(_ currentPercent: Int) -> LocalizedStringResource {
				LocalizedStringResource("achievements.progress.goalHalfway", defaultValue: "\(currentPercent)% progress toward your first goal")
			}
			static func progressSteadyState(_ current: Int, _ target: Int) -> LocalizedStringResource {
				LocalizedStringResource("achievements.progress.steadyState", defaultValue: "\(current) of \(target) days with same weight")
			}
	...
	enum Debug {
		...
		enum Achievements {
			...
			static let requiresPro = LocalizedStringResource("debug.achievements.requiresPro", defaultValue: "Requires My Weight Pro")
